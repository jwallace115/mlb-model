...
## 2026-09-22T07:31Z  cowork
- VERIFIED eng/5l @986ca24 from files: engine diff 2 lines; test_engine_5l 3 pass / 3 fail with main's engine; item-2 Brier table recomputed from parquets (all 11 cells better); item-4 SD 0.1487 recomputed.
...
## 2026-09-25T18:12Z  cowork (5T verification, D152, 5U order)
- RAN (Linux worktree eng/5t @ 2e12979): 4 games x {drive_log off,on} on main vs 5t engines -> byte-identical team outputs; record_player_off_hash.py -> 2b9666346a810f9f = 31de7e75f17b878b (same as the Mac's 5S value); test_engine_5t 2 pass; test_engine_5m player_off_hash FAILED on the branch as pushed (fixture not re-recorded; fixed in this merge); run_tied_expiry_5t.py -> 340/33 reproduced; D149 cells recomputed from phase5t_int_chain.parquet; real-side INT cells rebuilt from PBP 2021-24.
- WROTE: research/nfl_sim/phase5t_verification_2026-09-25.md, D152 (appended at merge), research/nfl_sim/workorder_5U_2026-09-25.md, nfl/sim/tests/fixtures/player_off_hash.json (+2b9666346a810f9f).
